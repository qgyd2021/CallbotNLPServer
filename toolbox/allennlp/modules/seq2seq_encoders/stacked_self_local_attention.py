...
from toolbox.allennlp.modules.seq2seq_encoders.multi_head_self_local_attention import MultiHeadSelfLocalAttention


@Seq2SeqEncoder.register('stacked_self_local_attention')
class StackedSelfLocalAttentionEncoder(Seq2SeqEncoder):
    def __init__(self,
                 num_layers: int,
                 input_dim: int,
        ...
        self._attention_layers: List[MultiHeadSelfLocalAttention] = []
        ...
        for i in range(num_layers):
            ...
            self_attention = MultiHeadSelfLocalAttention(
                left_size=left_size,
...
def demo1():
    ...
    attention = StackedSelfLocalAttentionEncoder(
        num_layers=2,
        input_dim=512,
    ...
    output = attention.forward(inputs, mask)
    print(output)
    return
