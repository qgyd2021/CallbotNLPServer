...
from server.callbot_nlp_server.schema.delete_scene import delete_scene_request_schema
...
class DeleteSceneHandler(BaseHandler):
    ...
    async def handle_post(self):
        ...
        # 请求体校验
        try:
            jsonschema.validate(args, delete_scene_request_schema)
